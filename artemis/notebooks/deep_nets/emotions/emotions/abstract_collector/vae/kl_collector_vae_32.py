...
create_dir(save_dir)
checkpoint_file = osp.join(save_dir, 'abstract/vae_32/kl_abstract.pt')
...
np.savez(embedding_dir+"/abstract/vae_32/vae_32_train_embedding_kl.npz",embedding=embedding_,index=index_)
print("finished!")
