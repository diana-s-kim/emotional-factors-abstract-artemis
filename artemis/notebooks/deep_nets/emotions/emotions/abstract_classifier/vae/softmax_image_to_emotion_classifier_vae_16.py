...
#save csv
artemis_data.to_csv(save_csv_dir+"/softmax_abstract.csv")
...
#param groups# (seems not effective as much as expected)# tuning could be done later.
