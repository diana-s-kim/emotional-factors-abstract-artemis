...
create_dir(save_dir)
checkpoint_file = osp.join(save_dir, 'all/kl_original_model.pt')
...
#save csv
artemis_data.to_csv(save_csv_dir+"all/kl_orignal.csv")
...
if not do_training or load_best_model:
    ...
    test_accuracy, test_confidence = accuracy_(model, data_loaders['train'], criterion, device, detailed=True)
